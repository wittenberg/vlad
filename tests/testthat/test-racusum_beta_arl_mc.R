...
test_that("Different Markov Chain algorithms, detecting deterioration", {
  ...
  MCtest <- list(
    racusum_beta_arl_mc(h=h, QA=QA, g0=g0, g1=g1, shape1=shape1, shape2=shape2, r=r, method=1),
    racusum_beta_arl_mc(h=h, QA=QA, g0=g0, g1=g1, shape1=shape1, shape2=shape2, r=r, method=2)
  )
