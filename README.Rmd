...
or install the development version from [GitHub](https://github.com/wittenberg/vlad) with:
...
Knoth S, Wittenberg P and Gan FF (2019). [Risk-adjusted CUSUM charts under model error](https://doi.org/10.1002/sim.8104). _Statistics in Medicine_, **38**(12), pp. 2206--2218.

Wittenberg P, Gan FF, Knoth S (2018). [A simple signaling rule for variable life-adjusted display derived from an equivalent risk-adjusted CUSUM chart](https://doi.org/10.1002/sim.7647).
_Statistics in Medicine_, **37**(16), pp 2455--2473.

Steiner SH, Cook RJ, Farewell VT and Treasure T (2000). [Monitoring surgical performance using risk-adjusted cumulative sum charts](https://doi.org/10.1093/biostatistics/1.4.441). 
